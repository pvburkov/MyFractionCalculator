...
import fractionpackage.Fraction;

public class CalcWork {
	
	/** 
	 *  Public class CalcWork has one property - String inputFilePath, where the full path to 
	 *  the file with math fraction tasks are held. If file cannot be accessed by this way, program 
	 *  will work in console mode.
	 * 
	 *  The main method of this class is public void work().
	 */
	...
	public void work() throws Exception {
		/**
		 * Method work() contains the full algorithm of the fraction calculator, including 
		 * textline-parser.
		 */
